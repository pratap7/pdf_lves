...
class TenantsController extends Controller {
    ...
    public function dbToPDF30Days($model = null, $type = 'single') {
        ...
        $html8 = '<div>TENANTS ARE ADVISED THAT THE LAS VEGAS JUSTICE COURT HAS INFORMATION ON IT’S WEBSITE CONCERNING THE AVAILABLITY OF MEDIATION, GOVERNMENT SPONSORED RENTAL ASSISTANCE, AND ELECTRONIC FILING FOR THE TENANT AFFIDAVIT, AMONG OTHER MATTERS. A TENANT MAY ACCESS THIS INFORMATION AT <a href="http://www.lasvegasjusticecourt.us/index.php">http://www.lasvegasjusticecourt.us</a></div>';
        $html_s1 = "You can fill out forms and file electronically at <a href='https://nevada.tylerhost.net/SRL/srl'>https://nevada.tylerhost.net/SRL/srl</a> (choose “SUMMARY EVICTION: Tenant Answer”). If you do not have internet access.";
        $h_city = "Las Vegas";
        if($model->LOCATION == 2){
            $html_s1 = "";
        ...
        $pdf->writeHTML('Your failure to pay rent or vacate the premises before the close of business on the 30th calendar day follow the Date of Service of this notice may result in your landlord applying to the Justice Court for an eviction order. If the court determines you are guilty of an unlawful detainer, the court may issue a summary order for your removal or an order providing for your non admittance, directing the sheriff/constable to post the order in a conspicuous place on the premises not later than 24 hours after the order is received by the sheriff/constable. The sheriff/constable shall then remove you not earlier than 24 hours but not later than 36 hours after posting of the order. Pursuant to NRS 118A.390, you may seek relief if a landlord unlawfully removes you from the premises, excludes you by blocking or attempting to block your entry upon the premises, or willfully interrupts or causes or permits the interruption of essential service required by the rental agreement or per chapter 118A of the Nevada Revised Statutes.');

        $pdf->Ln(3);
        $addr1 = $this->removeZipFromAddress($row['tenant_address']);
        $html_text1 = "<b>YOU ARE HEREBY ADVISED OF YOUR RIGHT T CONTEST THIS NOTICE by filing an Affidavit no later than by the close of business<sup>2</sup> on the 30th calendar day following the Date of Service of this notice, with the Justice Court for the city of " . $model->CITY.", stating that you have tendered payment or are not in default of rent. " . $html_s1 . "You can file your forms in-person at the " .$h_city. " Justice Court located at " . $model->JUSTICE_COURT_ADDRESS . ".<br>";
